// src/index.ts
import { createUser, getAllUsers, getActiveUsers, updateUserStatus } from './services/userService';
import { createProduct, getProductsByCategory, getInStockProducts } from './services/productService';
